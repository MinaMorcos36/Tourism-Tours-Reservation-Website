...
namespace TourismToursWebsite.Controllers
{
    public class ToursController : Controller
    {
        ...
        // GET: Tours
        public async Task<IActionResult> Index(string location, DateOnly? date, decimal? maxPrice, string sortOrder)
        {
            ...
            {
                "asc" => tours.OrderBy(t => t.Price),
                "desc" => tours.OrderByDescending(t => t.Price),
                _ => tours
            };
